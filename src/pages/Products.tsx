...
const products = [
  {
    id: 1,
    title: "Automotive Progressive Die",
    category: "Progressive Dies",
    image: precisionImage,
    description: "High-speed progressive die for automotive bracket production. 24-station design with automated feeding system.",
  },
  {
    id: 2,
    title: "Multi-Station Transfer Die",
    category: "Transfer Dies",
    image: cncImage,
    description: "Complex transfer die system for large automotive structural components with integrated welding stations.",
  },
  {
    id: 3,
    title: "Precision Stamping Tool",
    category: "Stamping Tools",
    image: heroImage,
    description: "High-precision stamping tool for electronic connector housings with micro-tolerances.",
  },
  {
    id: 4,
    title: "Custom Assembly Fixture",
    category: "Custom Tooling",
    image: factoryImage,
    description: "Custom-designed assembly fixture for automated production line integration.",
  },
  {
    id: 5,
    title: "Medical Device Die",
    category: "Progressive Dies",
    image: craftsmanImage,
    description: "Precision progressive die for medical device components with cleanroom compatibility.",
  },
  {
    id: 6,
    title: "Aerospace Forming Tool",
    category: "Stamping Tools",
    image: precisionImage,
    description: "Specialized forming tool for aerospace-grade aluminum components with strict tolerance requirements.",
  },
  {
    id: 7,
    title: "Consumer Electronics Die",
    category: "Transfer Dies",
    image: cncImage,
    description: "High-volume transfer die for smartphone housing components with premium surface finish.",
  },
  {
    id: 8,
    title: "Inspection Gauge Set",
    category: "Custom Tooling",
    image: heroImage,
    description: "Complete inspection gauge set for quality control of stamped automotive parts.",
  },
];
